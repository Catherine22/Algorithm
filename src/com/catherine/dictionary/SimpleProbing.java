 ...
 *
 */
class SimpleProbing extends Probing {

	private static class InstanceHolder {
		private static SimpleProbing instance = new SimpleProbing();
	}

	public static SimpleProbing getInstance() {
		INSTANCE = InstanceHolder.instance;
		return InstanceHolder.instance;
	}

	protected SimpleProbing() {
		getInstance();
	}
